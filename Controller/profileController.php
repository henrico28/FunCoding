<?php
	...
	class ProfileController{
        ...
        public function start(){
            ...
            JOIN Bahasa ON MasterSoal.IdBahasa = Bahasa.IdBahasa JOIN Level ON MasterSoal.IdLevel = Level.IdLevel JOIN Pengguna ON Ujian.Username = Pengguna.Username WHERE Username = '$user'";
