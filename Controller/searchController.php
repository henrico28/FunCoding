<?php
	...
	class SearchController{
		...
		public function search(){
			...
			session_write_close();
			$qValidate = "SELECT NamaBahasa, NamaLevel, Skor FROM Ujian JOIN MasterSoal ON Ujian.IdMasterSoal = MasterSoal.IdMasterSoal JOIN Bahasa ON MasterSoal.IdBahasa = Bahasa.IdBahasa JOIN lvl ON MasterSoal.IdLevel = lvl.IdLevel WHERE Username = '$user',NamaBahasa != '$bahasa', NamaLevel != '$level'";
